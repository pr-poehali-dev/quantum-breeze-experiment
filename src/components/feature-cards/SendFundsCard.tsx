import { Zap, Building2, ChevronDown, Info, TrendingUp } from "lucide-react"
...
export function SendFundsCard() {
  return (
    <div className="rounded-2xl bg-[#141414] border border-[#262626] p-6 flex flex-col">
      ...
      <h3 className="mb-2 text-lg font-semibold text-white">Платежи без задержек</h3>
      <p className="mb-4 text-sm text-gray-400">Переводите поставщикам и подрядчикам в один клик — платёж уходит мгновенно</p>

      <a href="#" className="mb-6 inline-flex items-center text-sm text-violet-400 hover:text-violet-300 transition-colors">
        Отправить платёж <ArrowUpRight className="ml-1 h-4 w-4" />
      </a>
      ...
      <div className="mt-auto space-y-4 rounded-xl bg-[#1a1a1a] border border-[#262626] p-4">
        ...
        <div>
          ...
          <div className="relative">
            <textarea
              placeholder="Например: оплата по договору №123 от 01.04.2025..."
        ...
        <div className="flex items-center justify-between pt-2">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-gray-400">Автоплатёж по расписанию</span>
          </div>
        </div>
      </div>
    </div>
